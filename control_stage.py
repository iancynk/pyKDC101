...
k.move_home(s)
time.sleep(2)
k.sendcommand(s, k.commands["move_stop"])
...
# %%
k.sendcommand(s, k.commands["req_poscounter"])
reply = k.recvreply(s)
k.sendcommand(s, k.commands["req_enccounter"])
reply = k.recvreply(s)
reply = '42 04 00 00 01 00'
a = k.decode_reply(reply)
